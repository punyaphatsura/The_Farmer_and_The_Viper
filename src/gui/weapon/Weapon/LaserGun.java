...
import gui.weapon.bullet.LaserGunBullet;
...
public class LaserGun extends Weapon {
	...
	public LaserGun(int x, int y) {
		...
		setFireRate(800);
		setTexture("lasergun.png");
		initializeShootingSound("laser.wav");
	}
		...
		Thread shootingThread = new Thread(() -> {
			...
			while (isShooting()) {
				...
				if (!getAlreadyShoot()) {
					...
					Bullet bullet = new LaserGunBullet(this.xShootPosition, this.yShootPosition);
